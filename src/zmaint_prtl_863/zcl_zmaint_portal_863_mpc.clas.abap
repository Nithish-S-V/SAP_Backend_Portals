class ZCL_ZMAINT_PORTAL_863_MPC definition
  public
...
TT_LOGIN type standard table of TS_LOGIN .
  ...
  types:
     TS_PLANTLIST type ZPLANTLIST_S_863 .
  types:
TT_PLANTLIST type standard table of TS_PLANTLIST .
  types:
     TS_NOTIFICATION_MAINT type ZNOTIFS_S_863 .
  types:
TT_NOTIFICATION_MAINT type standard table of TS_NOTIFICATION_MAINT .
  types:
     TS_WORKORDER type ZWORKORDER_S_863 .
  types:
TT_WORKORDER type standard table of TS_WORKORDER .
  ...
  constants GC_NOTIFICATION_MAINT type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Notification_Maint' ##NO_TEXT.
  constants GC_PLANTLIST type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'PlantList' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZMAINT_PORTAL_863_MPC=====CP' ##NO_TEXT.

  methods DEFINE_LOGIN
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_PLANTLIST
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_NOTIFICATION_MAINT
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS ZCL_ZMAINT_PORTAL_863_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZMAINT_PORTAL_863_SRV' ).

define_login( ).
define_plantlist( ).
define_notification_maint( ).
define_workorder( ).
  endmethod.
...
lo_property = lo_entity_type->create_property( iv_property_name = 'Engineerid' iv_abap_fieldname = 'ENGINEERID' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZLOGIN_S_863'
...
lo_entity_set->set_filter_required( abap_false ).
  ...
  method DEFINE_NOTIFICATION_MAINT.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - Notification_Maint
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Notification_Maint' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'Notificationid' iv_abap_fieldname = 'NOTIFICATIONID' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Equipmentid' iv_abap_fieldname = 'EQUIPMENTID' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Plannergroup' iv_abap_fieldname = 'PLANNERGROUP' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Notiftype' iv_abap_fieldname = 'NOTIFTYPE' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Starttime' iv_abap_fieldname = 'STARTTIME' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Prioritytype' iv_abap_fieldname = 'PRIORITYTYPE' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 2 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Maintplant' iv_abap_fieldname = 'MAINTPLANT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 4 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZNOTIFS_S_863'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'Notification_MaintSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'PlantList' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Plantid' iv_abap_fieldname = 'PLANTID' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 4 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZPLANTLIST_S_863'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'PlantListSet' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Locationplant' iv_abap_fieldname = 'LOCATIONPLANT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 4 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Costingsheet' iv_abap_fieldname = 'COSTINGSHEET' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZWORKORDER_S_863'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20251202235158'.                  "#EC NOTEXT
...
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Notification_Maint'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
